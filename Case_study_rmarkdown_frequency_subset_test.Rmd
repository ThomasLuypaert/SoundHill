...
### 2.5. Subsetting the frequency spectrum 3 different ways
...
sample_list_total <- sample_list
  ...
  # 2. Frequency subset between 2 kHz and 8 kHz

sample_list_2_8 <- sample_list

for (i in 1:length(sample_list_2_8)){

  for(j in 1:length(sample_list_2_8[[i]])){

    sample_list_2_8[[i]][[j]]@merged_df <- sample_list_2_8[[i]][[j]]@merged_df[93:nrow(sample_list_2_8[[i]][[j]]@merged_df)-11,]

    sample_list_2_8[[i]][[j]]@binarized_df <- sample_list_2_8[[i]][[j]]@binarized_df[93:nrow(sample_list_2_8[[i]][[j]]@binarized_df)-11,]
    
  }
}

  # 3. Frequency subset below 11,025 Hz
...
for (i in 1:length(inc_mat_2_8)){

  for (j in 1:length(inc_mat_2_8[[i]])){

    inc_mat_2_8[[i]][[j]] <- unlist(sample_list_2_8[[i]][[j]]@binarized_df)

  }


  inc_mat_2_8[[i]] <- as.data.frame(t(data.frame(do.call(rbind, inc_mat_2_8[[i]]))))
  rownames(inc_mat_2_8[[i]]) <-  paste0("OSU", seq(1, nrow(inc_mat_2_8[[i]]), 1))
  inc_mat_2_8[[i]] <- as.matrix(inc_mat_2_8[[i]])

}

names(inc_mat_2_8) <- wanted
...
rarefied_sounddiv_2_8 <- inc_mat_2_8

for (i in 1:length(rarefied_sounddiv_2_8)){

  rarefied_sounddiv_2_8[[i]] <- NA
...
for (i in 1:length(inc_mat_2_8)){
  ...
  rarefied_sounddiv_2_8[[i]] <- estimateD(x = inc_mat_2_8[[i]],
                                          datatype = "incidence_raw",
                                          base =  "size",
                                          level = 8)

  
  rarefied_sounddiv_2_8[[i]] <- distinct(rarefied_sounddiv_2_8[[i]][,2:ncol(rarefied_sounddiv_2_8[[i]])])
  rarefied_sounddiv_2_8[[i]]$site <- names(rarefied_sounddiv_2_8)[i]

}

  # Separate the data frames by order of diversity 

rarefied_sounddiv_2_8 <- rbindlist(rarefied_sounddiv_2_8)

for (i in 1:length(rarefied_sounddiv_2_8)){

  rarefied_sounddiv_q0_2_8 <- subset(rarefied_sounddiv_2_8,
                                     rarefied_sounddiv_2_8$order==0)


  rarefied_sounddiv_q1_2_8 <- subset(rarefied_sounddiv_2_8,
                                     rarefied_sounddiv_2_8$order==1)


  rarefied_sounddiv_q2_2_8 <- subset(rarefied_sounddiv_2_8,
                                     rarefied_sounddiv_2_8$order==2)
...
rarefied_sounddiv_q0_2_8$qD <- (rarefied_sounddiv_q0_2_8$qD / (nrow(inc_mat_2_8[[1]])))*100
rarefied_sounddiv_q1_2_8$qD <- (rarefied_sounddiv_q1_2_8$qD / (nrow(inc_mat_2_8[[1]])))*100
rarefied_sounddiv_q2_2_8$qD <- (rarefied_sounddiv_q2_2_8$qD / (nrow(inc_mat_2_8[[1]])))*100
...
rarefied_sounddiv_q0_2_8$evenness <- rarefied_sounddiv_q2_2_8$qD / rarefied_sounddiv_q0_2_8$qD

rarefied_sounddiv_q0_2_8$evenness.LCL <- rarefied_sounddiv_q2_2_8$qD.LCL / rarefied_sounddiv_q0_2_8$qD.LCL

rarefied_sounddiv_q0_2_8$evenness.UCL <- rarefied_sounddiv_q2_2_8$qD.UCL / rarefied_sounddiv_q0_2_8$qD.UCL
...
rarefied_sounddiv_q0_2_8$site <- toupper(rarefied_sounddiv_q0_2_8$site)

rarefied_sounddiv_q0_2_8 <- merge(x=rarefied_sounddiv_q0_2_8,
                              y = total_richness,
                              by="site")
...
tax_func_richness_a_total <-
  ggplot(rarefied_sounddiv_q0_total, aes(total_tax, qD))+
...
tax_func_evenness_a_total <-
  ggplot(rarefied_sounddiv_q0_total, aes(total_tax, evenness))+
  geom_smooth(method = "lm", color="darkred", linetype="dashed", size=1)+
  geom_point(shape=21, color="black", fill="white", stroke=1.5, size=2)+
  stat_cor(
    aes(label = paste(tolower(..r.label..), ..rr.label.., ..p.label.., sep = "~`,`~")),
...
tax_func_richness_a_2_8 <-
  ggplot(rarefied_sounddiv_q0_2_8, aes(total_tax, qD))+
  geom_smooth(method = "lm", color="darkred", linetype="dashed", size=1)+
  geom_point(shape=21, color="black", fill="white", stroke=1.5, size=2)+
...
tax_func_richness_b_2_8 <- tax_func_richness_a_2_8 +
  ggforce::geom_mark_circle(
  aes(fill = site, label = "A2.", filter = site == "GARRAFA"),
  alpha = 0, show.legend = FALSE, color="darkred", size = 1.5,
  label.fontsize = 18, con.size = 1
...
tax_func_evenness_a_2_8 <-
  ggplot(rarefied_sounddiv_q0_2_8, aes(total_tax, evenness))+
  geom_smooth(method = "lm", color="darkred", linetype="dashed", size=1)+
  geom_point(shape=21, color="black", fill="white", stroke=1.5, size=2)+
  stat_cor(
    aes(label = paste(tolower(..r.label..), ..rr.label.., ..p.label.., sep = "~`,`~")),
...
tax_func_evenness_b_2_8 <- tax_func_evenness_a_2_8 +
  ggforce::geom_mark_circle(
  aes(fill = site, label = "B2.", filter = site == "JIQUITAIA"),
  alpha = 0, show.legend = FALSE, color="darkred", size = 1.5,
  label.fontsize = 18, con.size = 1
...
low_richness_aggregated_2_8 <- aggregate_df(binarized_soundscape = thresh_list[[29]], output = "incidence_freq")

low_richness_soundscape_2_8 <- heatmapper(aggregated_soundscape = low_richness_aggregated_2_8, type = "regular", annotate = FALSE, minfreq = 2000, maxfreq = 8000) + labs(tag = "A2.") + theme(plot.tag = element_text(size = 24, face = "bold"), axis.text.x = element_text(size=18),
        axis.text.y = element_text(size=18),
        axis.title.x = element_text(size=24),
        axis.title.y = element_text(size=24))+
  scale_x_datetime(breaks = scales::date_breaks("2 hours"), date_labels = "%H:%M", expand = c(0,0)) 
...
high_richness_aggregated_2_8 <- aggregate_df(binarized_soundscape = thresh_list[[41]], output = "incidence_freq")

high_richness_soundscape_2_8 <- heatmapper(aggregated_soundscape = high_richness_aggregated_2_8, type = "regular", annotate = FALSE, minfreq = 2000, maxfreq = 8000) + labs(tag = "A3.") + theme(plot.tag = element_text(size = 24, face = "bold"), axis.text.x = element_text(size=18),
        axis.text.y = element_text(size=18),
        axis.title.x = element_text(size=24),
        axis.title.y = element_text(size=24))+
  scale_x_datetime(breaks = scales::date_breaks("2 hours"), date_labels = "%H:%M", expand = c(0,0)) 

tax_richness_2_8 <- tax_func_richness_b_2_8 + low_richness_soundscape_2_8 + high_richness_soundscape_2_8
...
low_evenness_aggregated_2_8 <- aggregate_df(binarized_soundscape = thresh_list[[4]], output = "incidence_freq")

low_evenness_soundscape_2_8 <- heatmapper(aggregated_soundscape = low_evenness_aggregated_2_8, type = "regular", annotate = FALSE, minfreq = 2000, maxfreq = 8000) + labs(tag = "B2.") + theme(plot.tag = element_text(size = 24, face = "bold"), axis.text.x = element_text(size=18),
        axis.text.y = element_text(size=18),
        axis.title.x = element_text(size=24),
        axis.title.y = element_text(size=24))+
  scale_x_datetime(breaks = scales::date_breaks("2 hours"), date_labels = "%H:%M", expand = c(0,0)) 
...
high_evenness_aggregated_2_8 <- aggregate_df(binarized_soundscape = thresh_list[[12]], output = "incidence_freq")

high_evenness_soundscape_2_8 <- heatmapper(aggregated_soundscape = high_evenness_aggregated_2_8, type = "regular", annotate = FALSE, minfreq = 2000, maxfreq = 8000) + labs(tag = "B3.") + theme(plot.tag = element_text(size = 24, face = "bold"), axis.text.x = element_text(size=18),
        axis.text.y = element_text(size=18),
        axis.title.x = element_text(size=24),
        axis.title.y = element_text(size=24))+
  scale_x_datetime(breaks = scales::date_breaks("2 hours"), date_labels = "%H:%M", expand = c(0,0)) 
...
tax_evenness_2_8 <- tax_func_evenness_b_2_8 + low_evenness_soundscape_2_8 + high_evenness_soundscape_2_8

soundscape_2_8 <- tax_richness_2_8 / tax_evenness_2_8
